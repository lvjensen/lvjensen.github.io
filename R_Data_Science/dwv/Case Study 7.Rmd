...
download("http://scriptures.nephi.org/downloads/lds-scriptures.csv.zip", "/Users/loganjensen/Desktop/M335_Jensen_Loga/Case_Study_07/docs/data/scriptures.zip", mode = "wb")
unzip("/Users/loganjensen/Desktop/M335_Jensen_Loga/Case_Study_07/docs/data/scriptures.zip", exdir = file.path(getwd(),"/Users/loganjensen/Desktop/M335_Jensen_Loga/Case_Study_07/docs/data"))
file.remove('/Users/loganjensen/Desktop/M335_Jensen_Loga/Case_Study_07/docs/data/scriptures.zip')
scriptures <- read_csv("/Users/loganjensen/Desktop/M335_Jensen_Loga/Case_Study_07/docs/data/lds-scriptures.csv")
bmnames <- read_rds(gzcon(url("https://byuistats.github.io/M335/data/BoM_SaviorNames.rds")))
```
## Background
The Book of Mormon has over 500 pages of inspired writings. However, one might question if this book is actually Christian. to analyze these writings and the prophets that wrote it, I analyzed how often the Book of Mormon mentions the name of Christ or an affiliation to him.
